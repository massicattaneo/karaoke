    ...
    function R(R, ea) {
        ...
        W = function (b, a) {
            ...
            g = {
                ...
                bgcolor: c.bgColor,
                pluginspage: Oa + "www.macromedia.com/go/getflashplayer",
            ...
            if (g = na())if (c.oMC = S(c.movieID) || k.createElement("div"), c.oMC.id) {
                ...
                h = i = null;
                if (!c.useFlashBlock)if (c.useHighPerformance)i = {
                    ...
                    left: "0px", overflow: "hidden"
                        ...
                        top: "-9999px",
                        left: "-9999px"
                    }, m)i.left = Math.abs(parseInt(i.left, 10)) + "px";
        ...
        k.addEventListener ? k.addEventListener("DOMContentLoaded", E, !1) : k.attachEvent ? k.attachEvent("onreadystatechange", ua) : F({
            type: "NO_DOM2_EVENTS",
            fatal: !0
        });
